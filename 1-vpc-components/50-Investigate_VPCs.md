...
Navigate to the EC2 section of the console (browsing through Services -> EC2 at the top left) and locate the DCS1 server. Put a check in the box next to the server. In the informal page underneath you can see the subnet the server has been deployed to. If you click on the **Networking** tab you will be able to see the network interface details:
